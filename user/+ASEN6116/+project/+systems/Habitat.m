...
%             matter.phases.solid(this.toStores.TiF4_Solid_Output, 'TiF4_Solid_Out', struct('TiF4', .029), 293);
            ...
            matter.phases.gas(this.toStores.TiF4_Gas_Output, 'TiF4_Gas_Out', struct('O2', 25.2, 'F2', 24.5, 'SiF4', 50.3), 1, 293);

            % SiF4 Condenser Solid Output and Plasma Reactor Input
            matter.store(this, 'SiF4_Solid_Output', 10);
            matter.phases.solid(this.toStores.SiF4_Solid_Output, 'SiF4_Solid_Out', struct('SiF4', 0.503), 293);

            % SiF4 Condenser Gas Output and Fluorination Reactor Input
            matter.store(this, 'SiF4_Gas_Output', 10);
            matter.phases.gas(this.toStores.SiF4_Gas_Output, 'SiF4_Gas_Out', struct('O2', 0.252, 'F2', 0.245), 1, 293);
