classdef K_Furnace_Manip < matter.manips.substance.stationary
    ...
    methods (Access = protected)
        function update(this)
            ...
            fTiProduction = this.oMT.afMolarMass(this.oMT.tiN2I.Ti)/this.oMT.afMolarMass(this.oMT.tiN2I.TiF4)*afFlowRateIn(this.oMT.tiN2I.TiF4);
            ...
            fO2Consumption = this.oMT.afMolarMass(this.oMT.tiN2I.O2)*...
                ...
                .5*fCaOProduction/this.oMT.afMolarMass(this.oMT.tiN2I.MgO)+...
            ...
            afPartialFlowRates(this.oMT.tiN2I.Ti) = fTiProduction;


            % Account for excess fluorine
            afPartialFlowRates(this.oMT.tiN2I.K) = afFlowRateIn(this.oMt.tiN2I.K) - fKConsumption;

            afPartialFlowRates(this.oMT.tiN2I.O2) = afFlowRateIn(this.oMt.tiN2I.O2) - fO2Consumption;
