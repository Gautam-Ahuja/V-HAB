classdef setup < simulation.infrastructure
    ...
    methods
        ...
        function configureMonitors(this)
            ...
            oLogger.addValue('Habitat.toStores.K_Furnace_Liquid_Output.toPhases.K_Furnace_Liquid_Out', 'fMass', 'kg', 'Liquid KF Input');
            oLogger.addValue('Habitat.toStores.Electrolyzer_Solid_Output.toPhases.Electrolyzer_Solid_Out', 'fMass', 'kg', 'Solid Potassium Output');
            oLogger.addValue('Habitat.toStores.Electrolyzer_Gas_Output.toPhases.Electrolyzer_Gas_Out', 'fMass', 'kg', 'F2 Gas Output');
            oLogger.addValue('Habitat.toStores.Electrolyzer_Gas_Output.toPhases.Electrolyzer_Gas_Out', 'fPressure', 'Pa', 'F2 Output Pressure');
...
%             oLogger.addValue('Habitat.toChildren.TiF4_Condenser.toStores.TiF4_Condenser_Store.toPhases.TiF4_Condenser_Solid_Output', 'fMass', 'kg', 'TiF4 Solid Output');
        ...
        function plot(this)
            ...
            coPlot1{1,1} = oPlotter.definePlot({'"Liquid KF Input"'},'KF Electrolyzer Mass Inputs');
            coPlot1{1,2} = oPlotter.definePlot({'"Solid Potassium Output"', '"F2 Gas Output"'}, 'KF Electrolyzer Mass Outputs');
            coPlot1{1,3} = oPlotter.definePlot({'"F2 Output Pressure"'}, 'KF Electrolyzer Pressure Outputs');
