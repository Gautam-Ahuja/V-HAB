classdef setup < simulation.infrastructure
    ...
    methods
        ...
        function configureMonitors(this)
            ...
            oLogger.addValue('Habitat.toStores.Regolith_Supply.toPhases.Feed_Regolith', 'fMass', 'kg', 'Lunar Regolith Supply');
            oLogger.addValue('Habitat.toStores.F2_Storage.toPhases.Feed_F2', 'fMass', 'kg', 'Fluorine Gas Supply');
            oLogger.addValue('Habitat.toStores.Regolith_Gas_Output.toPhases.Reg_Gas_Out', 'fMass', 'kg', 'Gaseous Output');
            oLogger.addValue('Habitat.toStores.Regolith_Gas_Output.toPhases.Reg_Gas_Out', 'this.afMass(this.oMT.tiN2I.O2)', 'kg', 'Oxygen Output');
            oLogger.addValue('Habitat.toStores.Regolith_Solid_Output.toPhases.Reg_Solid_Out', 'fMass', 'kg', 'Solid Output');
            oLogger.addValue('Habitat.toStores.Regolith_Gas_Output.toPhases.Reg_Gas_Out', 'fPressure', 'Pa', 'Total Output Pressure');
            oLogger.addValue('Habitat.toStores.Regolith_Gas_Output.toPhases.Reg_Gas_Out', 'this.afPP(this.oMT.tiN2I.O2)', 'Pa', 'Output ppO2');
...
%             oLogger.addValue('Habitat.toChildren.TiF4_Condenser.toStores.TiF4_Condenser_Store.toPhases.TiF4_Condenser_Solid_Output', 'fMass', 'kg', 'TiF4 Solid Output');
        ...
        function plot(this)
            ...
            coPlot1{1,1} = oPlotter.definePlot({'"Lunar Regolith Supply"', '"Fluorine Gas Supply"'},'Regolith Reactor Mass Inputs');
            coPlot1{1,2} = oPlotter.definePlot({'"Solid Output"', '"Gaseous Output"', '"Oxygen Output"'}, 'Regolith Reactor Mass Outputs');
            coPlot1{1,3} = oPlotter.definePlot({'"Total Output Pressure"', '"Output ppO2"'}, 'Regolith Reactor Pressure Outputs')
